...
const ROLE_BASE_POSES = {
  ...
  coward: {
    eyes: { x: [0.074, 0.074], y: [-0.052, -0.052] },
...
export const SPECTATOR_PROFILES = {
  angry: {
    ...
    reactions: {
      pair_presented: { states: ['watching', 'tense', 'surprised'], duration: 0.9 },
      player_choice: { states: ['disapprove', 'tense', 'confused'], duration: 1.4 },
      guess_correct: { states: ['surprised', 'tense', 'approve'], duration: 1.6 },
      guess_wrong: { states: ['approve', 'disapprove', 'confused'], duration: 1.7 },
      streak_up: { states: ['tense', 'surprised', 'disapprove'], duration: 1.5 },
      category_complete: { states: ['celebrate', 'surprised', 'approve'], duration: 1.8 },
  ...
  kind: {
    ...
    reactions: {
      pair_presented: { states: ['watching', 'anticipation', 'approve'], duration: 0.8 },
      player_choice: { states: ['approve', 'surprised', 'watching'], duration: 1.4 },
      guess_correct: { states: ['celebrate', 'approve', 'surprised'], duration: 1.7 },
      guess_wrong: { states: ['sad', 'confused', 'tense'], duration: 1.6 },
      streak_up: { states: ['approve', 'celebrate', 'surprised'], duration: 1.5 },
      category_complete: { states: ['celebrate', 'approve', 'surprised'], duration: 1.8 },
      neutral: { state: 'idle', duration: 0.8 },
    },
  },
  silly: {
    ...
    reactions: {
      pair_presented: { states: ['watching', 'anticipation', 'confused'], duration: 0.8 },
      player_choice: { states: ['surprised', 'confused', 'approve'], duration: 1.3 },
      guess_correct: { states: ['celebrate', 'surprised', 'approve'], duration: 1.9 },
      guess_wrong: { states: ['confused', 'sad', 'surprised'], duration: 1.6 },
      streak_up: { states: ['celebrate', 'surprised', 'approve'], duration: 1.8 },
      category_complete: { states: ['celebrate', 'surprised', 'confused'], duration: 1.8 },
      neutral: { state: 'idle', duration: 0.8 },
    },
  },
  coward: {
    ...
    reactions: {
      pair_presented: { states: ['tense', 'watching', 'confused'], duration: 0.9 },
      player_choice: { states: ['tense', 'surprised', 'confused'], duration: 1.4 },
      guess_correct: { states: ['approve', 'surprised', 'celebrate'], duration: 1.5 },
      guess_wrong: { states: ['sad', 'tense', 'confused'], duration: 1.8 },
      streak_up: { states: ['surprised', 'approve', 'tense'], duration: 1.6 },
      category_complete: { states: ['approve', 'surprised', 'celebrate'], duration: 1.6 },
      neutral: { state: 'idle', duration: 0.8 },
    },
  },
};
